package live.mvplive.ui.activity.main;
...
public class Live_for_activity_util extends FragmentActivity implements
        ActivityCompat.OnRequestPermissionsResultCallback {

    private String TAG="Live_Permi_Activity";
    ...
    protected void showToast(final String toastContent) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(Live_for_activity_util.this, toastContent, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void showLongToast(final String toastContent) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(Live_for_activity_util.this, toastContent, Toast.LENGTH_LONG).show();
            }
        });
    }
    @Override
